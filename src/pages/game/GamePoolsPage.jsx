...
const GamePoolsPage = () => {
  ...
  async function fetchPoolsData() {
    ...
    try {
      ...
      const response = await axiosInstance.get(`/game/poolsData/${section}`);
  ...
  useEffect(() => {
    if (storePools) {
      const updated = groupGamePools(storePools);
      setCricketPoolsList(updated);
    }
  }, [storePools]);
  useEffect(() => {
    setSelected("Game");
...
//       {notify && windowWidth > 450 && (
//         <div className="absolute w-[100%] bottom-[130px] flex justify-center">
//           <Notify reference={notifyTimer} width={windowWidth} mode="dark" notify={notify} page="Home" />
//         </div>
//       )}
//       {notify && windowWidth <= 450 && (
//         <div className="absolute w-[100%] bottom-[70px] flex justify-center">
...
//         {/* {windowWidth >= 1024 && <Leftbar width={windowWidth} />} */}
//         <div
//           className={`postContents items-center h-[100vh] overflow-y-auto ${
...
//               ))}
//             {/* </div> */}
//             {!poolsLoading && cricketPoolsList.length && (
//               <div className={` h-[200px] mt-8 ${windowWidth > 450 ? "mb-[100px]  pl-4" : "mb-[50px]  pl-2"} w-full`}>
//                 <p
//                   className={`text-white font-extrabold ${windowWidth < 350 && "text-3xl"} ${windowWidth >= 350 && windowWidth < 768 && "text-5xl"} ${
//                     windowWidth >= 768 && "text-5xl"
...
//             )}
//           </div>
//           <div className="fixed z-20 bottom-0 w-[100vw] overflow-x-hidden mt-8 h-[60px] bg-gradient-to-b from-slate-900 to-black flex items-center">
//             <button
//               onClick={() => navigate(`/game/my-pools/view/Upcoming Pools`)}
//               className="h-full w-1/3 pl-3  text-white text-lg flex justify-center items-center font-semibold"
//             >
//               Upcoming
//             </button>
//             <button onClick={() => navigate(`/game/my-pools/view/Live Pools`)} className="h-full w-1/3 text-white text-lg flex justify-center items-center font-semibold">
